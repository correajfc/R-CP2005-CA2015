...
```{r diag-model-espaciales-copaap, fig.asp=1, fig.cap="Diagnóstico comparativo entre modelos de porcentaje de copa"}
...
grid.arrange (arrangeGrob(grobs = diagPltsOLS, ncol = 3,left ="OLS"),
              ...
              arrangeGrob(grobs = diagPltsSD.wd,ncol = 3, left = "SD Wd"),nrow =3)
```
