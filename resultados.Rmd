...
### Correlaciones y gráficos de dispersión bivariados 
...
t1<-summary(lm.mod.area_copa)$coefficients
knitr::kable(t1, digits=3, caption = "Coeficientes OLS de área de copa - Log(AC)" , booktabs = TRUE)
