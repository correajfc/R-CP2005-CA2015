...
t2<-rbind(c("$\\lambda$","Likelihood ratio","p-value"),
          r1)
knitr::kable(format = formato_render,  booktabs = T,unname(t2), digits=3,caption = 'Coeficiente de autocorrelación modelo SEM de área de copa $W_d$')
```


```{r coef-sd-copa-wq}
t1<-summary(sd.mod.log.area_copa.wq)$Coef
knitr::kable(format = formato_render,  booktabs = T,t1, digits=3,caption = 'Coeficientes del modelo SD de área de copa $W_q$')
```
...
t2<-rbind(c("$\\rho$","Likelihood ratio","p-value"),
          r1)
knitr::kable(format = formato_render,  booktabs = T,unname(t2), digits=3,caption = 'Coeficiente de autocorrelación modelo SD de área de copa $W_q$')
```
...
t2<-rbind(c("$\\rho$","Likelihood ratio","p-valor"),
          r1)
knitr::kable(format = formato_render,  booktabs = T,unname(t2), digits=3,caption = 'Coeficiente de autocorrelación modelo SD $W_d$ de porcentaje de área de copa ')
```
...
# knitr::kable(format = formato_render,  booktabs = T,t1, digits=5, caption = "Coeficientes OLS de porcentaje de área de espacios verdes " )
...
# knitr::kable(format = formato_render,  booktabs = T,t1, digits=5, caption = "Coeficientes OLS de porcentaje de indice de acceso areas-distancia " )
...
t1 %>% bind_cols(terminos = nombres_coef,.) %>% 
knitr::kable(format = formato_render,  booktabs = T, digits=5, caption = "Coeficientes OLS de áreas-distancia" ,  col.names = c("Término","Estimado","Error std.","t-valor","Pr(>|t|)"))
...
kable(x = tabla, format = formato_render,  booktabs = T,caption = "Resumen métricas de ajuste OLS Indice contenedor (%EV) y de acceso área-distancia ", digits = 5)
...
data_frame(metrica =nom_estimado_moran, 
           log_area =mt,
           cobertura =mt2) %>% 
knitr::kable(format = formato_render,  booktabs = T,col.names = c(" ","$W_{q}$","$W_{d}$"),
             digits=5,
...
t2<-rbind(c("$\\lambda$","Likelihood ratio","p-value"),
          r1)
knitr::kable(format = formato_render,  booktabs = T,t1, digits=3,caption = 'Coeficientes del modelo SEM de porcentaje de área de EV')
```
...
t2<-rbind(c("$\\lambda$","Likelihood ratio","p-value"),
          r1)
knitr::kable(format = formato_render,  booktabs = T,unname(t2), digits=3,caption = 'Coeficiente de autocorrelación modelo SEM de porcentaje de área de EV')
```
...
knitr::kable(format = formato_render,  booktabs = T,t1, digits=3,caption = 'Coeficientes del modelo SD índice de relación área distancia de EV')
```
...
t2<-rbind(c("$\\rho$","Likelihood ratio","p-value"),
          r1)
knitr::kable(format = formato_render,  booktabs = T,unname(t2), digits=3,caption = 'Coeficiente de autocorrelación modelo SD índice de relación área distancia de EV')
```
