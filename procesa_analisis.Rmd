...
Una alternativa metodológica es probar los 3 tipos de modelos con la matriz $W_d$ que resultó capturar mejor la asociacion espacial en ls datos y comparar sus resultados.
...
```{r mapa-resid-copa-modelo-all,  fig.cap="Mapas de residuos del modelo OLS y el mejor modelo con estructura espacial para área de copa"}
...
```{r mapa-resid-copaap-modelo-all, fig.cap="Mapas de residuos del modelo OLS y el mejor modelo con estructura espacial para el porcentaje de cobertura de copa"}
