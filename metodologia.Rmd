...
1. Probar autocorrelación espacial usando Moran’I en los residuos de los modelos de regresieon lineal con dos diseños de matriz $W$. Si la prueba muestra una correlación y un valor de significancia alta, se prueban modelos tipo SAR, SEM o SD para comparar su desempeño. 
