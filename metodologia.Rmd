...
1. Evaluar los residuos usando la prueba de correlación espacial de Moran’I usando al menos dos diseños de matriz W. Si la prueba muestra una correlación y un valor de significancia alta, se prueban modelos tipo SAR, SEM o SLX con base en los resultados de los test estadísticos de Lagrange. 
1. Selección del modelo que mejor se ajusta usando métricas de error y de ajuste como R2 y el criterio de Akaike.
<!-- 1. Buscar grupos de sectores censales que compartan características de las variables del modelo para la identificación de zonas con características comunes para usarse como dimensiones de análisis e interpretación de los resultados estadísticos y geoestadisticos. -->
